...
class BedType extends BookingObject
{
     ...
     */
    public function __construct(string $name, string $count, string $descriptionImperial, int $configurationId, string $description)
    {
        $this->name                = $name;
        $this->count               = $count;
    ...
    {
        return new self($array['name'], $array['count'], $array['description_imperial'], $array['configuration_id'], $array['description']);
    }

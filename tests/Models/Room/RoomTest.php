...
use BookingCom\Models\Room\Photo;
...
class RoomTest extends TestCase
{
    ...
    public function testInfo(): void
    {
        ...
        $this->assertInstanceOf(RoomInfo::class, $room->getInfo());
    }
    ...
    public function testFacilities(): void
    {
        ...
        $this->assertContainsOnlyInstancesOf(RoomFacility::class, $room->getFacilities());
    }

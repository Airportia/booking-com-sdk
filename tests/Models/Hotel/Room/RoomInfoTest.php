...
class RoomInfoTest extends TestCase
{
     ...
     * @return \BookingCom\Models\Hotel\Room\Info
     */
    public function createRoomInfoDefaultArray(array $additionalArray = []): Info
    {
        $basicArray = [
            'bookable' => true,
            'max_price' => 259,
    ...
    public function testBedrooms(): void
    {
        ...
        $this->assertContainsOnlyInstancesOf(\BookingCom\Models\Hotel\Room\Bedroom::class, $roomInfo->getBedrooms());
    }
}

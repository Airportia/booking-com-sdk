...
class RuleTest extends TestCase
{
    ...
    {
        $rule = new Rule('city_ids', new Where(), new IntegerValidator() ,QueryObject::RESULT_IMPLODE, ['whereCityIn']);
        $rule->callMethod([1, 3, 5]);

        $this->assertEquals(true, $rule->matchMethod('whereCityIn', ['whereCityIn', 'whereIdIn', 'whereCountryIn', 'whereTypeIn']));
        ...
        $this->assertEquals(['whereCityIn'],$rule->getMethodNames());
    }
}
